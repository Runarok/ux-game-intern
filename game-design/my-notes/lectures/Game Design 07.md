...
&#x20; * Input (playersystem) → Processing (engine systems) → Output (rendered game)
...
&#x20; * Difficult integration of toolscomponents
...
&#x20; * Freeaccessible models to grow ecosystem
...
* Loadsunloads content based on player position
...
* Move to advanced engines later (UnityUnreal)
